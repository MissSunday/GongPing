...
@interface LZPageViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,LZPageContentViewDelegate>
{
    CGRect _frame;
}
...
- (instancetype)initWithTitles:(NSArray *)titlesArray controllersClass:(NSArray *)controllersClass title:(NSString *)name WithFrame:(CGRect)frame view:(UIView*)view;
{
    if (self = [super init]) {
        self.title = name;
...
- (void)addCollectionMain{
    ...
    UICollectionView *collectionMain = [[UICollectionView alloc] initWithFrame:_frame collectionViewLayout:layout];
    ...
    collectionMain.backgroundColor = [UIColor groupTableViewBackgroundColor];

//
//  GPCaptainPeopleBlackListViewController.m
//  工平矿业
//
...
@interface GPCaptainPeopleBlackListViewController ()
@property (nonatomic,strong)UIView * headerView;

@end

@implementation GPCaptainPeopleBlackListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationItem.title = @"社区黑名单管理";

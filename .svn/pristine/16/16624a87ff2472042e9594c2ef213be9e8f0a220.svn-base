//
//  GPMineCommuintyNumberController.m
//  工平矿业
//
...
@interface GPMineCommuintyNumberController ()

@end

@interface GPMineCommuintyNumberController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
...
@implementation GPMineCommuintyNumberController
